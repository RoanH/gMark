 ...
 * @author Roan
 * @param loadTime The time required to load and {@link DatabaseGraph#addEdge(int, int, int) construct} the database graph in nanoseconds.
 * @param prepTime The time required to {@link Evaluator#prepare(nl.group9.quicksilver.core.spec.DatabaseGraph) prepare} the evaluator in nanoseconds. 
